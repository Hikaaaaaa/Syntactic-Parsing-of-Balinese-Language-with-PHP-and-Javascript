                    ...
                    <div id="mycarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner carousel">
                            <div class="carousel-item active" data-interval="4500">
                                <img src="img/bg1.jpg" class="img-fluid img" style="height: 400px;" alt="bg1">
                            </div>
                            <div class="carousel-item" data-interval="4500">
                                <img src="img/bg2.jpg" class="img-fluid img" style="height: 400px;" alt="bg2">
                            </div>
                            <div class="carousel-item" data-interval="4500">
                                <img src="img/bg3.jpg" class="img-fluid img" style="height: 400px;" alt="bg3">
                            </div>
                        </div>
